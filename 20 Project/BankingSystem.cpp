...
public:
    ...
    long getAccNo() const { return accountNumber; }   // Declare as const
    string getFirstName() const { return firstName; } // Declare as const
    string getLastName() const { return lastName; }   // Declare as const
    float getBalance() const { return balance; }      // Declare as const
